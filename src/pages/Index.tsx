...
const Index = () => {
  const stats = [
    ...
    { number: "100%", label: "Student Commitment" },
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mt-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center text-sm">
                ...
                <span className="flex items-center justify-center">📧 info@newdomain.com</span>
                <span className="flex items-center justify-center">📞 0687211598</span>
                <span className="flex items-center justify-center">🕒 Mon-Sat: 7:30 AM - 3:30 PM</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <footer className="py-12 bg-foreground text-white">
        <div className="container mx-auto px-4">
          ...
          <div className="border-t border-white/20 mt-8 pt-8 text-center text-white/60">
            <p>&copy; 2025 Allied Skills Training Centre. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
